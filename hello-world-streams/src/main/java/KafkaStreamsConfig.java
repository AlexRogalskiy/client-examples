...
public class KafkaStreamsConfig {
    ...
    public static KafkaStreamsConfig fromEnv() {
        ...
        return new KafkaStreamsConfig(bootstrapServers, applicationId, sourceTopic, targetTopic, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, oauthClientId, oauthClientSecret, oauthAccessToken, oauthRefreshToken, oauthTokenEndpointUri, saslMechanism, saslUser, saslPassword);
    }
